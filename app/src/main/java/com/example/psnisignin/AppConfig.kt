...
object AppConfig {
    ...
    val SLACK_USER_GROUP: String
        get() = stringValue("SLACK_USER_GROUP", BuildConfig.SLACK_USER_GROUP).trim()

    val SLACK_NOTIFICATION_TARGET: String
        get() = if (stringValue("SLACK_NOTIFICATION_TARGET", BuildConfig.SLACK_NOTIFICATION_TARGET)
                .equals("Individuals", ignoreCase = true)) "Individuals" else "Channel"
