...
class AdminEditActivity : BaseHomeActivity() {
    ...
    private lateinit var visitingInput: EditText
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        visitingInput = findViewById(R.id.visitingInput)
    ...
    private fun loadRecord() {
        ...
        try {
            ...
            visitingInput.setText(record.visiting ?: "")
    ...
    private fun submitEdit() {
        ...
        val visiting = visitingInput.text.toString().trim()
        ...
        try {
            val changed = app.database.adminEdit(recordId, signIn, signOut.ifBlank { null }, visiting.ifBlank { null }, reason.ifBlank { null })
            if (!changed) {
                showMessage("Record not found.")
                return
            }
